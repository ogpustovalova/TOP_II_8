...
| Отзывы на банки (`banks.csv`) | [`text_classification.ipynb`](https://github.com/sozykin/dlpython_course/blob/master/05_text_processing/text_classification.ipynb) загружает [`train2.csv`](https://www.dropbox.com/scl/fi/mhiwx4plaua183bnuqt5e/train2.csv?rlkey=wv4dalbsutmzu5br9qv5ez21v&dl=1) | MIT; в М5 заменён на Russian Reviews Classification | 2026-07-22 |

### Проверка лицензии `banks.csv`

- Исходный ноутбук курса скачивает `train2.csv` и сохраняет его как `banks.csv`.
  Проверенная 2026-07-22 копия содержит 13 999 записей (`id`, `text`, `label`),
  SHA-256: `aaef2536652b8590e878962e08e7bd21bd0f17bc2f5b9196542e7e414540dc5c`.
- В [предоставленном обсуждении](https://chatgpt.com/share/6a6097ee-7998-83ed-be58-97a8a2eb0b6b)
  приведена лицензия MIT со страницы Kaggle
  `nikee7/t1-sentiment-classification-russian-reviews`.
...
> **Методическая заметка.** Для прохождения чек-листа достаточно зафиксировать
> источник, заявленную владельцем страницы лицензию, условия использования и дату
> проверки. Независимый юридический аудит происхождения данных не входит в
> критерий; обнаруженные сомнения описываются как ограничения, но сами по себе не
> переводят карточку ресурса в статус «Частично».
