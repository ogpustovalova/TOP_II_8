...
nb.add(md("### 5. Сравнение learning rate: 1e-2, 1e-3 и 1e-4"))
nb.add(sol("""LEARNING_RATES = [1e-2, 1e-3, 1e-4]
LR_EPOCHS = 6
lr_histories = {}
lr_results = []
...
nb.add(md("""Слишком малый `lr=1e-4` обычно даёт плавное, но медленное обучение.
...
nb.add(md("---\n## Часть В. Ручная ранняя остановка"))
nb.add(md("### 7. Early stopping с восстановлением лучших весов"))
nb.add(sol("""EARLY_STOP_MAX_EPOCHS = 20
