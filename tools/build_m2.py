...
- **DL-1.1 (С):** задаёт скорость обучения, выбирает функцию потерь, применяет
  регуляризацию и прореживание, выбирает размер пакета для SGD.
